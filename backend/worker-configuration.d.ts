/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f7d659fe6273261824240de96c2abb35)
// Runtime types generated with workerd@1.20260828.1 2026-08-29 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ALLOWED_ORIGINS: "https://ratemycards.manishbisht.me,http://localhost:5173,http://localhost:4173";
	ADMIN_TOKEN: string;
	ADMIN_EMAILS: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "ADMIN_TOKEN" | "ADMIN_EMAILS" | "CLERK_WEBHOOK_SIGNING_SECRET" | "CLERK_SECRET_KEY" | "RAZORPAY_KEY_ID" | "RAZORPAY_KEY_SECRET">> {}
}
